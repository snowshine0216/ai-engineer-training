...
// Unit-tests for the pure reducer and toTimelineRow helper exported implicitly
// by page.tsx. Since these are not exported, we re-implement them here to match
// the source exactly and test every branch.  This is the standard strategy for
// non-exported reducer logic in Next.js "use client" pages.
//
// Covers:
...
// ---- Inline the pure pieces from page.tsx (no JSX dependency) ----
